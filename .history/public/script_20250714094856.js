...
document.addEventListener('DOMContentLoaded', () => {
  ...
  console.log('Record hotkey button found:', recordHotkeyBtn);
...
document.addEventListener('keydown', (e) => {
  ...
  console.log('Key pressed during recording:', e.key, 'Ctrl:', e.ctrlKey, 'Shift:', e.shiftKey, 'Alt:', e.altKey);
  e.preventDefault();
  ...
  if (modifiers.length > 0) {
    ...
    console.log('Updated recorded keys:', recordedKeys);
  }
});
